...
public sealed class BH0009DontDivideByConstantZeroAnalyzer : BHAnalyzer {
    ...
    private static bool IsIntegerOrDecimalType(ITypeSymbol typeSymbol) => typeSymbol.SpecialType is
    ...
    private static bool IsZero(object? value) => value is
        byte and 0 or sbyte and 0
