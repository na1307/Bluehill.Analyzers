...
public sealed class BH0008CodeFixProvider : CodeFixProvider {
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context) {
        ...
        context.RegisterCodeFix(CodeAction.Create(CodeFixResources.BH0008CodeFixTitle, _ => removeRepeatedNegatedPatterns(context.Document, node, root), nameof(CodeFixResources.BH0008CodeFixTitle)), diagnostic);
    }
